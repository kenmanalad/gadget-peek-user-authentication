...
export class RefreshPrismaFilter extends HttpExceptionFilter{
    constructor(
        ...
        switch(exception.code){
            ...
            case "P2020":
            case "P2000":
                responseObject("The session information provided is too long. Please try signing in again.", HttpStatus.CONFLICT);
                break
            ...
            case "P2006":
            case "P2007":
                responseObject("The session token you provided is invalid. Please review and try again.", HttpStatus.BAD_REQUEST);
                break
            default:          
