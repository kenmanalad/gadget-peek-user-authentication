...
export class RegistrationPrismaFilter extends HttpExceptionFilter{
        ...
        switch(exception.code){
            ...
            case "P2020":
            case "P2000":
                responseObject("The information you entered is too long. Please shorten it and register again.", 400);
                break
            
            case "P2002":
                responseObject("The email address is already registered/verified", 409);
                break
            ...
            case "P2006":
            case "P2007":
                responseObject("One or more fields contain invalid values. Please review your input.", 400);
                break
            default:          
