...
export class VerifyCodePrismaFilter extends HttpExceptionFilter{
            ...
            switch(exception.code){
                ...
                case "P2020":
                case "P2000":
                    responseObject("The email address/code you submitted is too long. Please submit the correct input.", HttpStatus.BAD_REQUEST);
                    break
                
                case "P2025":
                    responseObject("Incorrect email address/code. Please submit valid input.",HttpStatus.NOT_FOUND);
                    break
                ...
                case "P2006":
                case "P2007":
                    responseObject("The email address/code contains invalid values. Please review your input.", HttpStatus.BAD_REQUEST);
                    break
                default:          
